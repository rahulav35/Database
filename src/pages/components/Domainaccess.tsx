  ...
  return (
    <div className="h-[70px] w-[460px]  flex items-start justify-start flex-col text-sm text-white font-normal mt-7 ml-20 ">
      ...
      <div className="h-[70px] w-[460px] flex items-center justify-between mt-2 ">
        <div className="min-h-[45px] w-[330px] bg-[#625a5a] rounded-lg flex flex-col justify-evenly items-center">
          <input
            className="h-[45px] w-[330px] bg-[#625a5a] p-2 box-border rounded-lg "
            type="text"
            placeholder="!"
          />
        </div>
